			...
			<div class="col-md-8 cont-grids">
				<div class="content-left-grids">
					<div class="content-middle">
                        <div style="width: px;overflow: auto;" align="center">
                                  <center><h1> User Uploaded Images</h1></center><br>	
                                <form name="myform"  method="post">
                                    <table border="5"  bordercolor=#33CCFF >
                                        ...
                                        <tr align="center" >
                                            ...
                                            <td style="background-color: green;color: white ">IMAGE</td>
                                            ...
                                            <%try {
                                                    ...
                                                    //rs = db.Select("select * from imageuploadfolder where username='" + session.getAttribute("username") + "'");
                                                    rs=db.Select("select * from imageuploadfolder");
                                                    while (rs.next()) {
                                        ...
                                        <tr>
                                            <td><strong><font color='blue'><%=username%></font></strong></td>
                                         
                                            <td style="width:160px"><img src="image/upload/<%=rs.getString("filename")%>" style="width: 160px; height: 70px;"></td>
...
<div class="footer" style="width: 600px;margin-left:auto;margin-right: auto">
