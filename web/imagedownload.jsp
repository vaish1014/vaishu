...
// Can also be used with $(document).ready()
        ...
        <!--No Back word Home Page-->
			...
			function validate()
			{
	          	    var imagename1=document.getElementById('file').value;
	                    var imagename11 = /^[A-Aa-z0-9]+$/.test(imagename1);
	                    if(imagename1=="")
	                    {
	                    alert(' Key  field cant be empty');
	                    return false;
	                    }
	                    if (!imagename11)
	                    {
        ...
        <div class="content">
            ...
            <div class="container">
                ...
                <%
                    ...
                    ResultSet rs = db.Select("select * from userinsert where userid='" + id + "' and username='" + name + "'");
                    if (rs.next()) 
                    {
                    ...
                    <div class="h_menu4">
                        ...
                        <ul class="nav">
                            <li><a href="#">USER HOME</a>
                                <ul>
                                    <!--                                <li class="active"><a href="userhome.jsp">USERHOME</a></li>-->
                                    <li class="active"><a href="userview.jsp">USER VIEW</a></li>
                                </ul>
                            </li>
                            <li><a href="#">UPLOAD</a>
                                <ul>								
                ...
                <div class="col-md-8 cont-grids">
                    <div class="content-left-grids">
                        <div class="content-middle">
                            ...
                            <form action="downloadkey.jsp"  method="post"  onsubmit="return validate();">
                                <table align="center" cellpadding = "20"> 

                                    
                                    <tr>
                                        <td>Policy Id</td>
                                        <td><input type="text" name="id" id="id" value="<%=request.getParameter("id")%>" readonly=""/></td>
                                    </tr>
                                    <tr>
                                        <td>Enter Key</td>
                                        <td><input type="text" name="key" id="file"></td>
                                    </tr>
 
                                    <tr>
                                        <td>  </td><td> <input  type="submit"  size=15 type="text"  value="Download"/> </td>
                                    </tr>
                                </table>
                            </form>
                                    ...
                                    <%try {
                                                    ...
                                                    System.out.println("fileid:\t"+id2);
                                                    
                                                    rs1 = db1.Select("select * from imageupload where id='" + id2 + "'");
                                                    //rs=db.Select("select * from image");
                                                    while (rs1.next()) {
