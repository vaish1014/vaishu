    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                ...
                <div style="border-radius: 10px;width:1020px;margin-left: auto;margin-right: auto" class="navigation text-center">
                    <!-- start h_menu4 -->
                    ...
                    <div class="h_menu4">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="uploadimages.jsp">UPLOAD IMAGES</a>
                                <ul>								
                                    <li><a href="viewuploadimages.jsp">VIEW UPLOAD IMAGES</a></li>
                                    <li><a href="dbimagessearch.jsp">IMAGES SEARCH</a></li>
                                </ul>
                            </li>        														
                            <li><a href="contentdatasearch.jsp">CONTENT BASED SEARCH</a>
                                <ul>								
                                    <li><a href="metadatasearch.jsp">META DATA BASED SEARCH</a></li>
                                </ul>
                            </li>
                            <li><a href="imagetotext.jsp">CONVERT IMAGE TO TEXT</a>
                                <ul>								
                                    <li><a href="texttoimage.jsp">CONVERT TEXT TO IMAGE</a></li>															
                                </ul>
                            </li>												
                ...
                <div class="col-md-8 cont-grids">
                    <div class="content-left-grids">
                        <div class="content-middle">
                            ...
                            <form action="dbimagessearch.jsp"  method="post"  onsubmit="return validate();">
            ...
            //rs=db1.Select("SELECT id,file FROM imageupload where imagename like'%"+iname5+"%' and username='"+session.getAttribute("username")+"'");   
            rs=db1.Select("SELECT * FROM imageupload where imagename like'%"+iname5+"%'");   
...
{                        // opening while loop brackets.   
 ...
 <td>
     <div style=""><img border="1" src="selectimage.jsp?imagename=<%=iname5%>" height="160" width="160" /></div>
